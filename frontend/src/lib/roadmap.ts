/**
 * The roadmap: sixteen rungs — Intern to Principal, four per band —
...
/**
 * The rung's market title — "Intern", "Strong Junior", "Senior+", "Principal"
 * — looked up by `<band>-<step>`, since the ladder's names do not follow from
