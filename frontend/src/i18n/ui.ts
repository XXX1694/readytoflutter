...
export const UI = {
  en: {
    ...
    nav: {
      ...
      allStacks: 'Every stack',
      signIn: 'Sign in',
      account: 'Account',
      docs: 'Docs',
      writeItFirst: 'Write it first',
      due: (n: number) => `${n} due`,
    },
    ...
    roadmap: {
      ...
      nextUp: 'Next',
      allPassed: 'Every level passed',
      passed: 'Passed',
      current: 'Current',
      drillRung: 'Practice this level',
      drillNext: 'Practice the next level',
      drillNode: 'Practice these',
  ...
  ru: {
    ...
    nav: {
      ...
      search: 'Поиск',
      session: 'Сессия',
      timed: 'Сессия на время',
      live: 'Живое кодирование',
      followups: 'Разбор',
      start: 'Старт',
      startSession: 'Начать сессию',
      stack: 'Стек',
      browseTopics: 'Все темы',
      allStacks: 'Все стеки',
      signIn: 'Войти',
      account: 'Аккаунт',
      docs: 'Документация',
      writeItFirst: 'Сначала своими словами',
      due: (n: number) => `${n} на повторение`,
    },
    ...
    roadmap: {
      ...
      nextUp: 'Дальше',
      allPassed: 'Все уровни пройдены',
      passed: 'Пройден',
      current: 'Текущий',
      drillRung: 'Пройти уровень',
      drillNext: 'Пройти следующий уровень',
