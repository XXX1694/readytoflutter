...
export const LANDINGS: Record<string, LandingConfig> = {
  flutter: {
    ...
    en: {
      ...
      docTitle: 'Flutter & Dart Interview Prep — Irbisa',
    ...
    ru: {
      ...
      docTitle: 'Подготовка к Flutter-собесу — Irbisa',
  ...
  ios: {
    ...
    en: {
      ...
      docTitle: 'iOS Interview Prep — Swift, SwiftUI, UIKit · Irbisa',
    ...
    ru: {
      ...
      docTitle: 'Подготовка к iOS-собесу — Swift, SwiftUI, UIKit · Irbisa',
  ...
  android: {
    ...
    en: {
      ...
      docTitle: 'Android Interview Prep — Kotlin, Compose · Irbisa',
    ...
    ru: {
      ...
      docTitle: 'Подготовка к Android-собесу — Kotlin, Compose · Irbisa',
  ...
  kmp: {
    ...
    en: {
      ...
      docTitle: 'KMP / Compose Multiplatform Interview Prep — Irbisa',
    ...
    ru: {
      ...
      docTitle: 'Подготовка к KMP / Compose Multiplatform собесу — Irbisa',
