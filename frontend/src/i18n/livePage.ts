...
const en = {
  ...
  editorHint: 'Tab indents, Shift+Tab steps back, Enter keeps your place. Nothing runs — there is no compiler here, and there is none in the room either.',
  submit: 'Submit',
...
const ru: typeof en = {
  ...
  editorHint: 'Tab — отступ, Shift+Tab — назад, Enter держит уровень. Код не запускается: компилятора здесь нет, как и на собеседовании.',
  submit: 'Сдать',
