...
import { GradeNotes, PaywallPanel, VerdictHeading } from './AiVerdict';
...
const errorMessage = (code: string | undefined, lang: Lang): string =>
  aiErrorMessage(code, lang, lang === 'ru' ? 'Вопрос не найден в базе.' : 'Question not found.');
  ...
  return (
    <section className="mb-5 rounded-lg border border-rule/12 bg-paper-2 p-4 shadow-codex-sm sm:p-5">
      <header className="mb-3 flex flex-wrap items-center justify-between gap-2">
        <VerdictHeading verdict={grade.verdict} score={grade.score} lang={lang} />
        <button
          type="button"
          onClick={onRetry}
