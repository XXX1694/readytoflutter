...
const RU: Copy = {
  ...
  test: 'Отправить тест',
  testing: 'Отправляем',
  denied: 'Браузер блокирует уведомления для Onsite, и страница не может это отменить. Разреши уведомления для этого сайта в настройках браузера и вернись сюда.',
  needsInstall: 'На iPhone и iPad уведомления работают только после добавления Onsite на экран «Домой». Нажми «Поделиться», затем «На экран „Домой“», и открой оттуда.',
  errors: {
    unsupported: 'Этот браузер не поддерживает уведомления.',
    needs_install: 'Сначала добавь Onsite на экран «Домой».',
