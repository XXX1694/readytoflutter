...
const EN: Copy = {
  ...
  test: 'Send a test',
  testing: 'Sending',
  denied: 'This browser is blocking notifications for Irbisa, and the page cannot undo that. Allow notifications for this site in your browser settings, then come back.',
  needsInstall: 'On iPhone and iPad, notifications only work once Irbisa is on the Home Screen. Tap Share, then "Add to Home Screen", and open it from there.',
  errors: {
    unsupported: 'This browser does not support notifications.',
    needs_install: 'Add Irbisa to your Home Screen first.',
...
const RU: Copy = {
  ...
  test: 'Отправить тест',
  testing: 'Отправляем',
  denied: 'Браузер блокирует уведомления для Irbisa, и страница не может это отменить. Разреши уведомления для этого сайта в настройках браузера и вернись сюда.',
  needsInstall: 'На iPhone и iPad уведомления работают только после добавления Irbisa на экран «Домой». Нажми «Поделиться», затем «На экран „Домой“», и открой оттуда.',
  errors: {
    unsupported: 'Этот браузер не поддерживает уведомления.',
    needs_install: 'Сначала добавь Irbisa на экран «Домой».',
    disabled: 'Напоминания не настроены на сервере.',
    denied: 'Уведомления заблокированы. Измени это в настройках браузера для этого сайта.',
    dismissed: 'Запрос разрешения закрыт без ответа. Попробуй снова, когда будешь готов.',
    no_service_worker: 'Service worker не запущен, доставлять некуда. Напоминаниям нужна продакшен-сборка.',
    failed: 'Не удалось включить напоминания. Проверь соединение и попробуй снова.',
  },
  testSent: 'Тестовое уведомление отправлено. Должно прийти через мгновение.',
  testErrors: {
    not_subscribed: 'Этот браузер не подписан. Сначала включи напоминания.',
    rate_limited: 'Слишком много тестовых уведомлений. Попробуй позже.',
    delivery_failed: 'Служба доставки отклонила запрос. Выключи и снова включи напоминания.',
